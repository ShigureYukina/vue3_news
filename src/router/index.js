...
const routes = [
	...
	// 新闻详情路由（带参数）
	{ path: '/news/:id', name: 'NewsDetail', component: NewsDetailPage, props: true, meta: { title: '新闻详情' } },
	// 分类页面路由
	{ path: '/categories', name: 'Categories', component: CategoriesPage, meta: { title: '新闻分类' } },
	// 分类新闻路由（带参数）
	{
	...
	// 缓存新闻路由
	{ path: '/archived', name: 'ArchivedNews', component: ArchivedNewsPage, meta: { title: '缓存新闻' } },
	// 动态演示页面路由
	{ path: '/dynamic-demo', name: 'DynamicDemo', component: DynamicDemoPage, meta: { title: '动态组件演示' } },
	// 关于我们路由
	{ path: '/about', name: 'About', component: AboutPage, meta: { title: '关于我们' } },
	// 首页重定向
	{ path: '/home', redirect: '/' },
	// 404页面路由（捕获所有未匹配的路径）
